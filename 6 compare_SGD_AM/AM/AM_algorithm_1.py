...
def algorithm_1(x_train, y_train, x_test, y_test, x_validation, 
                y_validation, x_test_sb, y_test_sb,
    ...
    x_test_sb_norm = (x_test_sb - x_mean)/x_std
    y_test_sb_norm = (y_test_sb - y_mean)/y_std
    ...
    for i in range(M): 
        ...
        beta_test_sb, S_test_sb = min_fun(x_test_sb_norm, y_test_sb_norm, w, lambda_)
        f_est_test_sb = S_test_sb.dot(beta) * y_std + y_mean
    ...
    return beta, w, f_est_train, pred_validation, error_train_list, error_validation_list, error_valid_min, error_test_list, error_test_end, FVU_validation, SB_M1, SB_M2