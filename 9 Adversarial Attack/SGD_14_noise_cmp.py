...
x_train, x_valid, x_test = add_noise(x_train, x_valid, x_test, mean=0, sd=0.3)
x_train, x_valid, x_test = image_compress(x_train, x_valid, x_test, k=2)
...
plt.title('Accuracy')
plt.tight_layout()
plt.savefig('./sgd_14_noise_cmp.jpg')
plt.show()